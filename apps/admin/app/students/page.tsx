...
export default function StudentsPage() {
  const { students, currentStudent, setError, refreshData } = useApp();
  ...
  const handleSubmitAdd = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      await createStudent(formName.trim(), formGrade);
  ...
  return (
    <AdminLayout title="孩子管理">
      <div className="page-header">
        <h1 className="page-title">孩子管理</h1>
        <p className="page-subtitle">管理您的孩子信息，设置当前孩子</p>
      </div>
